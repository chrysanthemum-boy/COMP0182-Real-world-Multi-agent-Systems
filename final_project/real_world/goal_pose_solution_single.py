...
def run(agents, ids, obstacle):
    ...
    for i in range(len(agents)):
        t = threading.Thread(target=navigation_with_pid, args=(agents[i], ids[i], obstacle[i]))
        threads.append(t)
        t.start()
...
def main():
    ...
    try:
        ...
        coordinates2 = read_and_transform_waypoints("./cbs_output_2_fetch.yaml", matrix)
    ...
    # aruco_id1 = "id505"          # ArUco marker ID for localization
    ...
    # run([turtlebot_name1,turtlebot_name2],[aruco_id1,aruco_id2], coordinates_full)
    # time.sleep(2)
    # print(coordinates)
