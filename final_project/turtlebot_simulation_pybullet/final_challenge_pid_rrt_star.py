...
cbs_rrt_star.run(dimensions=env_params["map"]["dimensions"], obstacles=env_params["map"]["obstacles"], agents=agent_yaml_params["agents"], out_file="./final_challenge/cbs_output_pid_rrt_star.yaml")
cbs_schedule = read_cbs_output("./final_challenge/cbs_output_pid_rrt_star.yaml")
...
lock = threading.Lock()
finish = {agent_box_ids[0]: True, agent_box_ids[1]: True}
